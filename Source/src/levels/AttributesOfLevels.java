...
public abstract class AttributesOfLevels {
	...
	public static final int 
			...
			FIRST_LEVEL_LOTS_OF_TRACKERS_APPEAR = 7,
			FIRST_LEVEL_PAUSE_AND_SHOOT_APPEAR = 10,
			FIRST_LEVEL_SPASTICS_APPEAR = 8,
			FIRST_LEVEL_DURATION_BULLETS_APPEAR = 12,
			FIRST_LEVEL_COORDINATED_CIRCLE_ORBITERS_ATTACK_APPEARS = 18,
			FIRST_LEVEL_CIRCLE_ORBITERS_APPEAR = 18,
			FIRST_LEVEL_TRIANGLE_ORBITERS_APPEAR = 19,
			FIRST_LEVEL_RECTANGLE_ORBITERS_APPEAR = 20,
