...
public class Bonus_IncBulletDamageView extends BonusView implements GameObjectInterface{
	
	public static double DAMAGE_INCREASE_RATIO=1.1;
	
	public Bonus_IncBulletDamageView(Context context,float positionX,float positionY) {
