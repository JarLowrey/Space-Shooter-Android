...
public class Bullet_LaserLong extends Bullet{
	...
	double positionOnShooterAsAPercentage){
		...
		final int width=(int) context.getResources().getDimension(R.dimen.laser_two_width);
		final int height=(int) context.getResources().getDimension(R.dimen.laser_two_height);
